...
{
    public class DLQQueueSimpleScheduleConsumer
    {
        private readonly ILogger<DLQQueueSimpleScheduleConsumer> _logger;
        const string _queueName = "simple-schedule/$deadletterqueue";

        public DLQQueueSimpleScheduleConsumer(
            ILogger<DLQQueueSimpleScheduleConsumer> logger)
        {
            _logger = logger;
        }

        [Function(nameof(DLQQueueSimpleScheduleConsumer))]
